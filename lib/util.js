...
util.setStyle = function(returnObj, bb, t) {
  ...
  if (layout && JSON.stringify(layout) != '{}') {
    style = {
      ...
      'width': layout.size ? layout.size.width : undefined,
      'height': layout.size ? layout.size.height : undefined,
      'left': layout.position ? layout.position.x : undefined,
      'top': layout.position ? layout.position.y : undefined,
